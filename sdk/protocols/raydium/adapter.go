...
func (a *baseAdapter) Discover(ctx context.Context, req market.DiscoveryRequest) ([]*market.Pool, error) {
...
func NewLaunchLabAdapter(c rpc.Client, p parser.Adapter) *baseAdapter {
